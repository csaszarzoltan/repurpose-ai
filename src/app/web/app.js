...
async function loadSummary(){
  try{
    ...
    summary.setAttribute('aria-label',`Workspace attention summary: ${data.active_projects} active projects, ${data.projects_without_drafts} need drafts, ${data.draft_variants} drafts to review, ${data.approved_variants} approved.`);
...
form.addEventListener('reset',()=>{localStorage.removeItem(localDraftKey);draftState.textContent='Local draft cleared.'});
